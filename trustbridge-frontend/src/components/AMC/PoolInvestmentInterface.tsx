    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-gray-800 rounded-lg p-8 w-full max-w-md text-center">
          ...
          <h2 className="text-2xl font-bold text-neon-green mb-2">Investment Successful!</h2>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-2xl font-bold text-neon-green mb-2">{pool.name}</h2>
            ...
            <div className="bg-gray-700 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xl font-bold text-neon-green">${pool.totalValue.toLocaleString()}</p>
                </div>
                <div>
                  <p className="text-text-secondary text-sm">Expected APY</p>
                  <p className="text-xl font-bold text-green-400">{pool.expectedAPY}%</p>
                </div>
                <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    className="w-full bg-gray-600 border border-gray-500 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-neon-green"
                  />
                ...
                <div className="bg-gray-600 rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-green-400">${returns.annualReturn.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-text-secondary">Expected Monthly Return</span>
                      <span className="font-semibold text-green-400">${returns.monthlyReturn.toLocaleString()}</span>
                    </div>
                  </div>
                </div>
