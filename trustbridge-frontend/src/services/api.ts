...
export const apiService = {
  ...
  getHederaStatus: () => apiClient.get('/hedera/status').then(res => res.data),
  tokenizeAsset: (data: any) => apiClient.post('/hedera/tokenize', data).then(res => res.data),
  mintTokens: (data: any) => apiClient.post('/hedera/mint', data).then(res => res.data),
  getTokenInfo: (tokenId: string) => apiClient.get(`/hedera/token/${tokenId}`).then(res => res.data),
  verifyAsset: (data: any) => apiClient.post('/hedera/verify-asset', data).then(res => res.data),
