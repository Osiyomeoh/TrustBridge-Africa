...
const AssetVerification: React.FC = () => {
  ...
  const handleVerificationRequest = async () => {
    ...
    try {
      ...
      const attestorType = 0; // LEGAL_EXPERT for now
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Create asset in backend (without tokenId - that's handled separately)
          ...
          processingTime: Date.now() - startTime // Calculate actual processing time
                  ...
                  if (walletType === 'metamask' && response.data.assetId) {
                    try {
                      ...
                      // Map verification level to attestor type
                      // For now, use LEGAL_EXPERT (0) for all verification levels
  ...
  const steps = isVerificationMode ? [
    ...
    { number: 7, title: 'Tokenization Complete', description: 'Asset successfully tokenized on Hedera network' }
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-center">
          <Button
            ...
            className="bg-neon-green hover:bg-electric-mint text-black px-8 py-3"
          >
            {isSubmitting ? (
              <>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-dark-gray border border-medium-gray rounded-md text-off-white focus:border-neon-green focus:outline-none"
                      required
                    >
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="flex items-center space-x-3">
                          <IconComponent className="w-5 h-5 text-electric-mint" />
                          <div>
                      ...
                      return (
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <span className="text-neon-green font-bold">{selectedLevel.fee}</span>
                          ...
                          <div className="flex-1">
                            ...
                            {doc.status === 'uploading' && (
                              <div className="flex items-center space-x-2 mt-1">
                                <div className="w-3 h-3 border-2 border-neon-green border-t-transparent rounded-full animate-spin"></div>
                                <p className="text-xs text-neon-green">Uploading...</p>
                              </div>
                            )}
