...
const PublicAssetViewer: React.FC = () => {
  ...
  const getStatusInfo = (status: number) => {
    switch (status) {
      ...
      case 1:
        return { label: 'Verified', color: 'bg-green-500/20 text-green-400 border-green-500/30', icon: CheckCircle };
      case 2:
            ...
            <Card className="bg-gray-900/50 border-gray-700/50 backdrop-blur-sm">
              ...
              <CardContent className="space-y-3">
                <Button
                  ...
                  className="w-full bg-neon-green hover:bg-electric-mint text-black"
                >
