...
exports.PoolTokensModule = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const pool_tokens_controller_1 = require("./pool-tokens.controller");
...
let PoolTokensModule = class PoolTokensModule {
};
exports.PoolTokensModule = PoolTokensModule;
exports.PoolTokensModule = PoolTokensModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        controllers: [pool_tokens_controller_1.PoolTokensController],
        providers: [pool_tokens_service_1.PoolTokensService],
        exports: [pool_tokens_service_1.PoolTokensService]
    })
], PoolTokensModule);
//# sourceMappingURL=pool-tokens.module.js.map