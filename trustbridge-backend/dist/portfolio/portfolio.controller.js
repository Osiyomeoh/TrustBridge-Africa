...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get user portfolio or portfolio summary' }),
    (0, swagger_1.ApiQuery)({ name: 'userId', required: false, description: 'User ID for specific portfolio' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User portfolio or portfolio summary' }),
