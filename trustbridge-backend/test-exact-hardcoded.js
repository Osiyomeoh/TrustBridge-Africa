...
/**
 * Test script to verify exact hardcoded values approach
 */

console.log('🧪 Testing Exact Hardcoded Values Approach\n');
...
// Calculate with exact hardcoded values
...
console.log('🔢 Exact Hardcoded Values:');
...
// Test with different price values to see if any give us exactly zero
...
console.log('\n💡 Analysis:');
if (sum === 0) {
  console.log('  ✅ Exact hardcoded values give us exactly zero!');
  console.log('  ✅ This should work with Hedera transactions');
} else {
  console.log('  ❌ Even exact hardcoded values have floating-point errors');
  console.log('  ❌ This suggests JavaScript floating-point arithmetic is the issue');
}

console.log('\n🎯 Recommendation:');
if (sum === 0) {
  console.log('  Use exact hardcoded values approach');
} else {
