...
export declare namespace TRUSTMarketplace {
...
export interface TRUSTMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "LISTER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "getAssetListings",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTrustToken",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface TRUSTMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): TRUSTMarketplace;
  waitForDeployment(): Promise<this>;

  interface: TRUSTMarketplaceInterface;
  ...
  getAssetListings: TypedContractMethod<
  ...
  getListing: TypedContractMethod<
    [listingId: BigNumberish],
    [TRUSTMarketplace.ListingStructOutput],
    "view"
  >;

  getOffer: TypedContractMethod<
    [listingId: BigNumberish, buyer: AddressLike],
    [TRUSTMarketplace.OfferStructOutput],
    "view"
  >;
  ...
  setTrustToken: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "getAssetListings"
  ): TypedContractMethod<
    [nftContract: AddressLike, tokenId: BigNumberish],
    [bigint[]],
    "view"
  ...
  getFunction(
    nameOrSignature: "setTrustToken"
  ): TypedContractMethod<[_trustToken: AddressLike], [void], "nonpayable">;
  getFunction(
